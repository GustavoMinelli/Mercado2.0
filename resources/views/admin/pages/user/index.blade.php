                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-primary btn-sm" role="button" href="{{ url('users/'.$user->id.'/show') }}">Detalhes</a>
                                <a class="btn btn-primary btn-sm" role="button" href="{{ url('users/'.$user->id.'/delete') }}"><i class="fa-sharp fa-solid fa-trash"></i></a>
                            </td>
                        </tr>
